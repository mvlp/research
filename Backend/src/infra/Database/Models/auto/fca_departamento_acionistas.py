...
class fca_departamento_acionistas(db.Model):
    ...
    Contato = db.Column(db.Text, nullable=True)
    Data_Fim_Contato = db.Column(db.Date, nullable=True)
    Data_Inicio_Contato = db.Column(db.Date, nullable=True)
