...
class fre_membro_comite(db.Model):
    __tablename__ = "fre_membro_comite"

    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    arquivo_origem = db.Column(db.Text, nullable=True)
    tipo_csv = db.Column(db.Text, nullable=True)

    Cargo_Ocupado = db.Column(db.Text, nullable=True)
    ...
    Descricao_Outro_Cargo_Ocupado = db.Column(db.Text, nullable=True)
    Descricao_Outros_Comites = db.Column(db.Text, nullable=True)
    ...
    Tipo_Comite = db.Column(db.Text, nullable=True)
