...
class fca_escriturador(db.Model):
    __tablename__ = "fca_escriturador"
    ...
    CNPJ_Escriturador = db.Column(db.Text, nullable=True)
    ...
    Escriturador = db.Column(db.Text, nullable=True)
