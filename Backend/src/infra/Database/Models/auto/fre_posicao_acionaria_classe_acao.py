...
class fre_posicao_acionaria_classe_acao(db.Model):
    __tablename__ = "fre_posicao_acionaria_classe_acao"
    ...
    Percentual_Acoes = db.Column(db.Numeric(18, 6), nullable=True)
